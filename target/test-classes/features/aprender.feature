...
Funcionalidade: Aprender Cucumber
  Como um aluno
  Eu quero aprender o cucumber
  Para que eu possa automatizar

  Cenario: Deve executar expecificação
  ...
  Cenario: Calcula atraso na entrega
    Dado que a entrega é 05/04/2018
    Quando a entrega atrasar em 2 dias
    Entao a entrega será em 07/04/2018

  Cenario: Calcula atraso na entrega da china
    Dado que a entrega é 05/04/2018
    Quando a entrega atrasar em 2 meses
    Entao a entrega será em 05/06/2018
